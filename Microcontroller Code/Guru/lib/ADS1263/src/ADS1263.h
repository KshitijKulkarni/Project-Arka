...
/*
	Modified version of github.com/freudenthal/ADS1263
	Library modief to make it SPI Bus Agnostic by passing SPIClass pointer during construction.
*/
...
class ADS1263
{
	public:
		...
		ADS1263(uint8_t InitCSSelectPin, SPIClass* InitSPI);
		ADS1263(uint8_t InitCSSelectPin, uint8_t InitDataReadyPin, SPIClass* InitSPI);
		ADS1263(uint8_t InitCSSelectPin, uint8_t InitDataReadyPin, uint8_t InitStartPin, SPIClass* InitSPI);
		//
		bool Begin();
